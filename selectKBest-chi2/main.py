...
result_data = run_mr_job(AvgAndSum, ["./input/input_file copy.txt", "--n", "7"])
write_data_to_file("./selectKBest-chi2/output/avg_sum.txt", result_data)

result_data = run_mr_job(ClassProbability, ["./input/items copy.txt", "--n", "7"])
...
# Define k
k = 2  # Number of highest values to select
