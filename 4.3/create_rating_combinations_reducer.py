...
def create_rating_combinations_reducer():
    data = read_mapper_output(
        '../output/create_rating_combinations_mapper.txt', '\t')
    outputFile = open('../output/create_rating_combinations_reducer.txt', 'w')
...
create_rating_combinations_reducer()
