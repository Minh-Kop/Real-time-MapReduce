...
input_file_train_df.to_csv("./input/input_file_1M_train.txt", index=False, header=False)
input_file_test_df.to_csv("./input/input_file_1M_test.txt", index=False, header=False)

# save train_item and test_item
item_file_train_df.to_csv("./input/items_1M_train.txt", index=False, header=False)
item_file_test_df.to_csv("./input/items_1M_test.txt", index=False, header=False)
